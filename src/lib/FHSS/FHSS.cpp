...
const fhss_config_t domains[] = {
    ...
    {"P560",  FREQ_HZ_TO_REG_VAL(550000000), FREQ_HZ_TO_REG_VAL(570000000), 20, 560000000},
    {"P600",  FREQ_HZ_TO_REG_VAL(590000000), FREQ_HZ_TO_REG_VAL(610000000), 20, 600000000},
    {"P630",  FREQ_HZ_TO_REG_VAL(620000000), FREQ_HZ_TO_REG_VAL(640000000), 20, 630000000},
    {"P650",  FREQ_HZ_TO_REG_VAL(640000000), FREQ_HZ_TO_REG_VAL(660000000), 20, 650000000},
};
