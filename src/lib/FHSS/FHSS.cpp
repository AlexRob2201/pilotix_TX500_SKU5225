...
const fhss_config_t domains[] = {
    ...
    {"550~570/20",  FREQ_HZ_TO_REG_VAL(550000000), FREQ_HZ_TO_REG_VAL(570000000), 20, 560000000},
    {"565~595/40",  FREQ_HZ_TO_REG_VAL(565000000), FREQ_HZ_TO_REG_VAL(595000000), 40, 580000000},
    {"565~595/20",  FREQ_HZ_TO_REG_VAL(565000000), FREQ_HZ_TO_REG_VAL(595000000), 20, 580000000},
    {"590~610/20",  FREQ_HZ_TO_REG_VAL(590000000), FREQ_HZ_TO_REG_VAL(610000000), 20, 600000000},
    {"620~640/20",  FREQ_HZ_TO_REG_VAL(620000000), FREQ_HZ_TO_REG_VAL(640000000), 20, 630000000},
    {"640~660/20",  FREQ_HZ_TO_REG_VAL(640000000), FREQ_HZ_TO_REG_VAL(660000000), 20, 650000000},
};
