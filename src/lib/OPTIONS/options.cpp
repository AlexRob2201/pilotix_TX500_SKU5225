...
__attribute__ ((used)) static firmware_options_t flashedOptions = {
    ...
    .domain = 7,
    #elif defined(Regulatory_Domain_P560_20)
    .domain = 8,
    #elif defined(Regulatory_Domain_P580_40)
    .domain = 9,
    #elif defined(Regulatory_Domain_P580_20)
    .domain = 10,
    #elif defined(Regulatory_Domain_P600_20)
    .domain = 11,
    #elif defined(Regulatory_Domain_P630_20)
    .domain = 12,
    #elif defined(Regulatory_Domain_P650_20)
    .domain = 13,
    #else
